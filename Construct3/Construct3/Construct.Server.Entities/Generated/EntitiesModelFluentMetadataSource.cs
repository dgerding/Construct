...
namespace Construct.Server.Entities
{
	...
	public partial class EntitiesModelFluentMetadataSource : FluentMetadataSource
	{
		...
		{
			configuration.HasAssociation(x => x.DataType).HasFieldName("dataTypes").WithOpposite(x => x.Visualizers).ToColumn("PrimitiveDataTypeID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.Visualizer).HasFieldName("visualizers").WithOpposite(x => x.Visualizations).ToColumn("VisualizerID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.DataTypeSource).HasFieldName("dataTypeSources").WithOpposite(x => x.Sources).ToColumn("DataTypeSourceID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.Items).HasFieldName("items").WithOpposite(x => x.Source).HasConstraint((y, x) =>  x.SourceId == y.ID ).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.SensorTypeSource).HasFieldName("sensorTypeSources").WithOpposite(x => x.SensorRuntimes).ToColumn("SensorTypeSourceID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.SensorHosts).HasFieldName("sensorHosts").WithOpposite(x => x.SensorHostType).HasConstraint((y, x) =>  x.SensorHostTypeID == y.ID ).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.SensorHostType).HasFieldName("sensorHostTypes").WithOpposite(x => x.SensorHosts).HasConstraint((x, y) =>  x.SensorHostTypeID == y.ID ).IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.Sensors).HasFieldName("sensors").WithOpposite(x => x.SensorHost).HasConstraint((y, x) =>  x.SensorHostID == y.ID ).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.SensorTypeSource).HasFieldName("sensorTypeSources").WithOpposite(x => x.SensorCommands).ToColumn("SensorTypeSourceID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.SensorHost).HasFieldName("sensorHosts").WithOpposite(x => x.Sensors).HasConstraint((x, y) =>  x.SensorHostID == y.ID ).WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.SensorTypeSource).HasFieldName("sensorTypeSources").WithOpposite(x => x.Sensors).ToColumn("SensorTypeSourceID").WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.SessionDesignNodes).HasFieldName("sessionDesignNodes").WithOpposite(x => x.SessionDesign).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.Property).HasFieldName("properties").WithOpposite(x => x.QuestionParameters).ToColumn("PropertyID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.Source).HasFieldName("sources").WithOpposite(x => x.Items).HasConstraint((x, y) =>  x.SourceId == y.ID ).IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.DataType).HasFieldName("dataTypes").WithOpposite(x => x.Items).ToColumn("DataTypeID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.DataTypeParent).HasFieldName("dataType1").WithOpposite(x => x.DataTypeChildren).ToColumn("DataTypeParentID").WithDataAccessKind(DataAccessKind.ReadWrite);
			...
			configuration.HasAssociation(x => x.SessionDesignNodes).HasFieldName("sessionDesignNodes").WithOpposite(x => x.DataType).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.DataTypeSource1).HasFieldName("dataTypeSource1").WithOpposite(x => x.DataTypeSources).HasConstraint((x, y) =>  x.ParentID == y.ID ).WithDataAccessKind(DataAccessKind.ReadWrite);
			...
			configuration.HasAssociation(x => x.DataTypeSources).HasFieldName("dataTypeSources").WithOpposite(x => x.DataTypeSource1).HasConstraint((y, x) =>  x.ParentID == y.ID ).WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.SensorHostType).HasFieldName("sensorHostTypes").WithOpposite(x => x.SensorDataTypeSources).ToColumn("SensorHostTypeID").WithDataAccessKind(DataAccessKind.ReadWrite);
		...
		{
			configuration.HasAssociation(x => x.SessionDesignNode).HasFieldName("sessionDesignNodes").WithOpposite(x => x.SessionNodes).WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.DataType).HasFieldName("dataTypes").WithOpposite(x => x.SessionDesignNodes).WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.SessionDesign).HasFieldName("sessionDesigns").WithOpposite(x => x.SessionDesignNodes).WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.SessionNodes).HasFieldName("sessionNodes").WithOpposite(x => x.SessionDesignNode).IsManaged().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.SensorCommand).HasFieldName("sensorCommands").WithOpposite(x => x.SensorCommandParameters).ToColumn("SensorCommandID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
		...
		{
			configuration.HasAssociation(x => x.Taxonomy).HasFieldName("taxonomies").WithOpposite(x => x.TaxonomyLabels).ToColumn("TaxonomyID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
			configuration.HasAssociation(x => x.Label).HasFieldName("labels").WithOpposite(x => x.TaxonomyLabels).ToColumn("LabelID").IsRequired().WithDataAccessKind(DataAccessKind.ReadWrite);
		}
