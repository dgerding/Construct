...
/****** Object:  StoredProcedure [dbo].[AddDoublePropertyValue]    Script Date: 07/18/2014 10:50:26 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AddDoublePropertyValue]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[AddDoublePropertyValue]
GO
...
CREATE PROCEDURE [dbo].[AddDoublePropertyValue]
