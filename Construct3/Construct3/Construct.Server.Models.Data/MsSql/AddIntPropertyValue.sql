...
/****** Object:  StoredProcedure [dbo].[AddIntPropertyValue]    Script Date: 07/18/2014 10:51:09 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AddIntPropertyValue]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[AddIntPropertyValue]
GO
...
CREATE PROCEDURE [dbo].[AddIntPropertyValue]
