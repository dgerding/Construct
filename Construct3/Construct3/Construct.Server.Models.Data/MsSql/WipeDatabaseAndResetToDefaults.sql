...
/****** Object:  StoredProcedure [dbo].[WipeDatabaseAndResetToDefaults]    Script Date: 07/18/2014 11:00:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WipeDatabaseAndResetToDefaults]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WipeDatabaseAndResetToDefaults]
GO
...
CREATE PROCEDURE [dbo].[WipeDatabaseAndResetToDefaults]
AS 
    BEGIN
-----------------------------================= DataTypeSources
