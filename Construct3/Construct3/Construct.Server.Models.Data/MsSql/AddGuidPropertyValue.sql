...
/****** Object:  StoredProcedure [dbo].[AddGuidPropertyValue]    Script Date: 07/18/2014 10:50:42 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AddGuidPropertyValue]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[AddGuidPropertyValue]
GO
...
CREATE PROCEDURE [dbo].[AddGuidPropertyValue]
