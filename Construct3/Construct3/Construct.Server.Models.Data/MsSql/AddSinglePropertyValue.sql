...
/****** Object:  StoredProcedure [dbo].[AddSinglePropertyValue]    Script Date: 07/18/2014 10:51:52 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AddSinglePropertyValue]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[AddSinglePropertyValue]
GO
...
CREATE PROCEDURE [dbo].[AddSinglePropertyValue]
