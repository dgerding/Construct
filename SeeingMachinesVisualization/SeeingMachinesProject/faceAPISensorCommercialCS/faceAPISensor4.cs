...
{
	public class faceAPISensorCommercialCSSensor : Sensor
	{
		private readonly Dictionary<string, string>
		availableCommands = new Dictionary<string,string>();

		faceAPI4SensorLogic sensorLogic = new faceAPI4SensorLogic();

		public faceAPISensorCommercialCSSensor(string[] args)
			: base(
				Protocol.HTTP,
				...
				})
		{
			...
			sensorLogic.OnNewData += sensorLogic_OnNewData;
		}
