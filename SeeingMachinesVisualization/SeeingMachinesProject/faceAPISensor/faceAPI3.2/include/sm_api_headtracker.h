...
/*! @brief Obtains estimate of the head-pose that is interpolated from the time of call.

    The time of call of the function effects the output result. 
    The function interpolates to predict current head position and rotation at the time of call.
