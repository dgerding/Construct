...
using System.Linq;
using System.Text;
using ConstructGameMediaRecorder;
...
namespace ConstructGameMediaRecorder
{
    ...
    {
        public static string GetDecoratedMediaFileName(DateTime startedAt, DateTime endedAt, Location startLocation, string sensorID, string extension)
        {
