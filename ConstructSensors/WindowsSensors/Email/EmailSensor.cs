...
namespace Email
{
    public class EmailSensor : Sensor
    {
        ...
        public EmailSensor(string[] args)
            : base(Protocol.HTTP, args, Guid.Parse("405D4464-2BA8-49A9-AD98-99174B2EBCA3"), new Dictionary<string, Guid> { { "", Guid.Empty } })
        {
        ...
        private void GatherAvailableCommands()
        {
            ...
            availableCommands.Add("SubscribeToEmailAccount", "ImapServerHostName, ImapServerPost, UserName, Password, IsSSL, TargetMailboxName");
        }
